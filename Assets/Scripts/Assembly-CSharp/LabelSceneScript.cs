...
public class LabelSceneScript : MonoBehaviour
{
	...
	public virtual void UpdateMesh()
	{
		...
		for (int l = 0; l < list.Count; l++)
		{
			...
			int num6 = l * 4;
			int num7 = l * 6;
			Vector2 vector = sprite3.size * 0.5f * scene_zoom;
			Vector3 vector2 = new Vector3(sprite3.position.x * scene_zoom, sprite3.position.y * scene_zoom, 0f);
