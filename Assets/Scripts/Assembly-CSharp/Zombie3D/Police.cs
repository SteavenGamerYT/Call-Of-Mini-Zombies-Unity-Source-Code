...
namespace Zombie3D
{
	public class Police : Enemy
	{
		...
		public override void Init(GameObject gObject)
		{
			m_tip_height = 2f;
			base.Init(gObject);
			shieldCollider = enemyTransform.Find("Bip01/Bip01 Prop1/Zombie_Police_Shield").gameObject.GetComponent<Collider>();
			lastTarget = Vector3.zero;
			MonsterConfig monsterConfig = gConfig.GetMonsterConfig("Police");
