...
public class EndlessModeUI : MonoBehaviour
{
	...
	protected EndlessModeUIPanel endless_mode_panel;
	...
	private IEnumerator Init()
	{
		...
		endless_mode_panel = new EndlessModeUIPanel();
		endless_mode_panel.Start();
		endless_mode_panel.Show();
		m_UIManager.Add(endless_mode_panel);
