...
public class MultiplayCreateMapUI : MonoBehaviour
{
	public UIManager m_UIManager;

	public GameObject CreateMapObj;

	protected MultiplayCreateMapUIPanel endless_panel;
	...
	private IEnumerator Init()
	{
		...
		endless_panel = new MultiplayCreateMapUIPanel();
		endless_panel.CreateMap_TUI = CreateMapObj.transform.Find("SceneTUI").gameObject.GetComponent<CreateMapTUI>();
		endless_panel.Start();
